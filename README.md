...
Система для управления заявками на ремонт с разделением ролей (диспетчер и мастера). Проект контейнеризирован с использованием Docker и готов к запуску одной командой.
